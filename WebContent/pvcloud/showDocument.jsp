...
<div class="m">
	<table class="table table-responsive">
		<tr>
			<td>文档标题</td>
			<td><input type="text"  readonly="readonly" name="title" id="title" maxlength="30" placeholder="标题最长30个字" style="width: 300px;" value="${document.title}"/></td>
		</tr>
		<tr>
			<td>文档类型</td>
			<td>
    ...
    <div>
    		<textarea id="content" name="content" class="summernote" readonly>
    			${document.content}
			</textarea>
    </div>
